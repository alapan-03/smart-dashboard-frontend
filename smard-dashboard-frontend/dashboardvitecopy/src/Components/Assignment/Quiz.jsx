...
function Quiz(topicId) {
    ...
    const fetchQuestions = async () => {
      try {
        ...
        // if (response.ok) {
          ...
          setQuestions(response.data.questions); // Extract the questions
        // }
      } catch (error) {
  ...
  const submitQuiz = async () => {
    try {
      const postStudentAssignment = await axios.post(`${url}/student/submit`, {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-800 p-4 quiz-cont">
